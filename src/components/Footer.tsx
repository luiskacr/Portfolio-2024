  ...
  return (
    <footer className="mt-4">
      <div className="w-full mx-auto max-w-screen-xl p-4 flex flex-col items-center md:flex-row justify-center md:justify-between">
        <span className="text-sm sm:text-center text-zinc-800/90 dark:text-zinc-200/90 mb-6 md:mb-0 md:me-6 flex justify-center items-center text-black dark:text-white">
